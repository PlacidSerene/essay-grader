    ...
    <>
      ...
      <MaxWidthWrapper className="mb-12 mt-28 flex flex-col items-center justify-center text-center sm:mt-40">
        ...
        <h1 className="max-w-4xl text-5xl font-bold md:text-6xl lg:text-7xl">
          Grade Your <span className="text-green-600">Essays</span>
        </h1>
        <p className="max-w- mt-5 text-zinc-700 sm:text-lg">
          Chirp allows you to upload multiple IELTS essays as docx files. Simply
          upload your files and speed up the grading process.
        </p>
        <Link
        ...
        <div className="mb-12 px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">
              Grading IELTS essays has never been easier than with Chirp
            </p>
          </div>
        </div>
